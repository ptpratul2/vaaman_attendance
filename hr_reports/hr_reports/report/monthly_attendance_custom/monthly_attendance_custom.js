...
frappe.query_reports["Monthly Attendance Custom"] = {
	filters: [
		{
			fieldname: "month",
			label: __("Month"),
	...
	onload: function () {
		return frappe.call({
			method: "hr_reports.hr_reports.report.monthly_attendance_custom.monthly_attendance_custom.get_attendance_years",
			callback: function (r) {
